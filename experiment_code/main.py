...
gv = dict(
    ...
    n_blocks = 8,
    block_action_type = 'approach',  # or 'avoid'
    block_global_effort_state = 'low',  # or 'high'
    block_attention_focus = 'reward_rate',  # or 'heart_rate'
...
info = dict(
    ...
    effort_level = np.linspace(50, 100, 11),
    outcome_magnitude_level = np.linspace(2, 10, 5),
...
# present trial offer
effort_outcome_stimuli = hf.trial_stimuli(win, gv)
stimuli = [effort_outcome_stimuli, upper_button, upper_button_txt, lower_button, lower_button_txt]
hf.draw_all_stimuli(win, stimuli)
